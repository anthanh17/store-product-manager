...
type Querier interface {
	...
	GetCategorySummary(ctx context.Context) ([]GetCategorySummaryRow, error)
	...
	GetProductStatusSummary(ctx context.Context) ([]GetProductStatusSummaryRow, error)
	GetSession(ctx context.Context, id uuid.UUID) (Session, error)
	GetTotalCategories(ctx context.Context) (int64, error)
